const CURSOR_PRESETS = {
  ...
  'img-alien': 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M16 4c-6 0-10 6-10 12 0 8 4 12 10 12s10-4 10-12c0-6-4-12-10-12z" fill="lime"/><ellipse cx="12" cy="14" rx="3" ry="5" fill="black"/><ellipse cx="20" cy="14" rx="3" ry="5" fill="black"/></ellipse></svg>',
